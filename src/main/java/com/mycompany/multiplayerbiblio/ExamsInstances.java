...
public class ExamsInstances {
    ...
    public static Exam tema1Exam(){
        ...
        questions[5] = new Question("¿Puedo devolver un portátil en cualquier biblioteca?");
        ...
        questions[1].options(new String[]{"Entrando en la opción Mi Biblioteca del catálogo.","A través del formulario web o en papel.","Las otras opciones son correctas."});
